        ...
        <Box pt={5} pb={10} fontFamily="poppins" textAlign="center">
                    ...
                    <Flex mt={5}>
                      ...
                      <Center>
                        ...
                        <a
                          className={styles.SocialIcon}
                          target="_blank"
                          href="https://api.whatsapp.com/send/?phone=918011545825&text=I%27m+interested+to+talk+with+you!&type=phone_number&app_absent=0"
                        >
                          <Box ml={10} className={styles.iconBox}>
                            <Flex justifyContent="center" alignItems="center">
                              <BsTelephoneFill
          ...
          <Box>
            <Text className={styles.texts}>
              Designed and Developed by Abhijit Biswas,© Copyright 2022. All
              rights reserved.
            </Text>
          </Box>
        </Box>
